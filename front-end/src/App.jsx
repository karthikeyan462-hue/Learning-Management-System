...
import "./App.css";
import ZenLearnLogo from "./assets/ZenLearnLogo.png"; 
...
const LoadingScreen = () => (
  <div className="flex flex-col items-center justify-center min-h-screen bg-slate-50">
    <div className="relative">
      ...
      <img src={ZenLearnLogo} alt="ZenLearn" className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 object-contain" />
    </div>
    <h2 className="mt-6 text-xl font-black text-slate-800 tracking-tighter animate-pulse">ZenLearn</h2>
  </div>
);
